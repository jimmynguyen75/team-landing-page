...
export default function ContactMe({}: Props) {
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      <h3 className="absolute top-6 uppercase tracking-[20px] text-gray-500 text-2xl">Contact</h3>
      <div className="flex scale-75 flex-col space-y-10">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-xl">+84 868 4705 98</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <MapPinIcon className="text-[#F7AB0A] h-7 animate-pulse" />
            <p className="text-xl">minhthusdb@gmail.com</p>
          </div>
          <div className="flex items-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#F7AB0A] h-7 animate-pulse" />
            <p className="text-xl">OWL Team</p>
          </div>
        </div>
